  ...
  >
    ...
    >
      <el-form-item label="Poster Photo" size="large">
        <div class="upload-card h-60 w-full object-cover" @click="selectImage">
          <img
            v-show="imgSrc"
            id="preview_img"
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        >
          <el-select v-model="form.category" placeholder="Select" filterable>
            <el-option
          ...
          <InputError class="mt-2" :message="$page.props.errors.category" />
        </el-form-item>
      </div>
      <div>
