<template>
    ...
    <AuthenticatedLayout>
      <div class="p-4 container mx-auto overflow-x-auto">
        <h4 class="text-lg font-bold mb-3 ml-1">Zodiacs</h4>
    ...
    setup() {
      ...
      const handleDelete = (id) => {
        ElMessageBox.confirm("Are you sure you want to delete?", "Warning", {
          ...
          .then(() => {
            router.delete(route("admin.zodiacs.destroy", id), {
              onSuccess: (page) => {
      ...
      const getData = () => {
        ...
        router.get("/admin/zodiacs", state.param, {
          preserveScroll: true,
          preserveState: true,
          replace: true,
          onFinish: () => {
      ...
      const reset = () => {
        router.get(route("admin.zodiacs.index"));
      };
